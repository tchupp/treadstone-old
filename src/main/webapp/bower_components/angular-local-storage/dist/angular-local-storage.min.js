 ...
 */!function (a, b, c) {
    ...
    var e = b.isDefined, f = b.isUndefined, g = b.isNumber, h = b.isObject, i = b.isArray, j = b.extend, k = b.toJson, l = b.module("LocalStorageModule", []);
    l.provider("localStorageService", function () {
        ...
        }, this.$get = ["$rootScope", "$window", "$document", "$parse", function (a, b, c, l) {
            function m(a, b) {
                return "true" === b || "false" === b ? "true" === b : b
            }

            var n, o = this, p = o.prefix, q = o.cookie, r = o.notify, s = o.storageType;
            c ? c[0] && (c = c[0]) : c = document, "." !== p.substr(-1) && (p = p ? p + "." : "");
            var t = function (a) {
                return p + a
            }, u = function () {
                try {
                ...
                if (f(c) ? c = null : (h(c) || i(c) || g(+c || c)) && (c = k(c)), !u || "cookie" === o.storageType)return u || a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), r.setItem && a.$broadcast("LocalStorageModule.notification.setitem", {
                    key: b,
                    newvalue: c,
                    storageType: "cookie"
                }), B(b, c);
                ...
                return c && "null" !== c ? "{" === c.charAt(0) || "[" === c.charAt(0) || d(c) ? JSON.parse(c, m) : c : null
            }, x = function () {
                var b, c;
                for (b = 0; b < arguments.length; b++)if (c = arguments[b], u && "cookie" !== o.storageType)try {
                    n.removeItem(t(c)), r.removeItem && a.$broadcast("LocalStorageModule.notification.removeitem", {
                        key: c,
                        storageType: o.storageType
                    })
                } catch (d) {
                    a.$broadcast("LocalStorageModule.notification.error", d.message), D(c)
                } else u || a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), r.removeItem && a.$broadcast("LocalStorageModule.notification.removeitem", {
                    key: c,
                    storageType: "cookie"
                }), D(c)
            }, y = function () {
                ...
                if (f(d))return !1;
                if ((i(d) || h(d)) && (d = k(d)), !A)return a.$broadcast("LocalStorageModule.notification.error", "COOKIES_NOT_SUPPORTED"), !1;
                try {
                    var j = "", l = new Date, m = "";
                    if (null === d ? (l.setTime(l.getTime() + -864e5), j = "; expires=" + l.toGMTString(), d = "") : g(e) && 0 !== e ? (l.setTime(l.getTime() + 24 * e * 60 * 60 * 1e3), j = "; expires=" + l.toGMTString()) : 0 !== q.expiry && (l.setTime(l.getTime() + 24 * q.expiry * 60 * 60 * 1e3), j = "; expires=" + l.toGMTString()), b) {
                        var n = "; path=" + q.path;
                        q.domain && (m = "; domain=" + q.domain), c.cookie = t(b) + "=" + encodeURIComponent(d) + j + n + m
                    }
                } catch (o) {
                ...
                for (var d = c.cookie && c.cookie.split(";") || [], e = 0; e < d.length; e++) {
                    ...
                    if (0 === f.indexOf(t(b) + "=")) {
                        var g = decodeURIComponent(f.substring(p.length + b.length + 1, f.length));
                        try {
                            return JSON.parse(g, m)
                        } catch (h) {
                            return g
                        }
                    }
                ...
                for (var a = null, b = p.length, d = c.cookie.split(";"), e = 0; e < d.length; e++) {
                ...
                d = d || b;
                var f = w(d);
                return null === f && e(c) ? f = c : h(f) && h(c) && (f = j(c, f)), l(b).assign(a, f), a.$watch(b, function (a) {
                    v(d, a)
                }, h(a[b]))
            }, H = function () {
